...
// Define the generated resources and Java source directories inside the build folder
...
// Add the generated directories to the main source set so they get included in compilation, JAR, and classpath
